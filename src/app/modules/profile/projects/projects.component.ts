...
import { IconUserModel } from '../../../layouts/partials';
...
export class ProjectsComponent implements OnInit {
  users1: Array<IconUserModel> = [
    ...
    { name: 'Rudy Stone', avatar: './assets/media/avatars/300-11.jpg' },
  ...
  users3 = [
    ...
    { name: 'Cris Willson', avatar: './assets/media/avatars/300-11.jpg' },
